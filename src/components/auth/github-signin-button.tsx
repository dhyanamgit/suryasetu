...
export default function GitHubSignInButton() {
  ...
  return (
    <Button onClick={handleSignIn} disabled={isLoading} className="w-full" variant="secondary">
      {isLoading ? (
